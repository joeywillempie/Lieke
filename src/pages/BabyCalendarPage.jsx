...
export default function BabyCalendarPage() {
  ...
  function goToWeek(week) {
    navigate(`/babykalender/week/${week}`)
  }

  function goToMonth(month) {
    navigate(`/babykalender/maand/${month}`)
  }
        ...
        {BABY_WEEKS.map((item) => {
          ...
          return (
            <button
              ...
              className={`
                w-full text-left block rounded-2xl border transition-all
                ${isActive
            ...
            >
              <div className="flex items-center gap-3 p-3">
                ...
                <div className="flex-shrink-0">
                  <ChevronRight className={`w-4 h-4 ${isActive ? 'text-pink-400' : 'text-stone-300'}`} />
                </div>
              </div>
            </button>
          )
